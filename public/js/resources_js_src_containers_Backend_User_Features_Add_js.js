...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(id) {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_12__.getFeature(id));
    },
    post: function post(data) {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_12__.postFeatures(data));
    },
    patch: function patch(id, data) {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_12__.patchFeatures(id, data));
    },
    reset: function reset() {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_12__.resetFeatures());
    }
  };
};
