...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(id) {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_12__.getLanguage(id));
    },
    post: function post(data) {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_12__.postLanguages(data));
    },
    patch: function patch(id, data) {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_12__.patchLanguages(id, data));
    },
    reset: function reset() {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_12__.resetLanguages());
    }
  };
};
