...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(id) {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_13__.getUser(id));
    },
    info: function info() {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_13__.getUsersInfo());
    },
    post: function post(data) {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_13__.postUsers(data));
    },
    patch: function patch(id, data) {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_13__.patchUsers(id, data));
    },
    reset: function reset() {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_13__.resetUsers());
    }
  };
};
