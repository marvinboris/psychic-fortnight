...
/* harmony import */ var _store_actions_backend__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../../../store/actions/backend */ "./resources/js/src/store/actions/backend/index.js");
...
/* harmony import */ var _components_Content_Frontend__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../../components/Content/Frontend */ "./resources/js/src/components/Content/Frontend.js");
...
var SubNavLinks = function SubNavLinks(_ref2) {
  ...
  var keys = Object.keys(_components_Content_Frontend__WEBPACK_IMPORTED_MODULE_15__.default);
  var resourceTabPanes = keys.map(function (item) {
    var currentItem = _components_Content_Frontend__WEBPACK_IMPORTED_MODULE_15__.default[item];
  ...
  _createClass(Frontend, [{
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      if (nextProps.backend.cms.cms && prevState.app_name === '') {
        ...
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_14__.updateObject)(prevState, _objectSpread({}, frontend));
      }
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get() {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_13__.getCms());
    },
    patch: function patch(data) {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_13__.patchCms('frontend', data));
    },
    reset: function reset() {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_13__.resetCms());
    }
  };
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,react_router_dom__WEBPACK_IMPORTED_MODULE_27__.withRouter)((0,react_redux__WEBPACK_IMPORTED_MODULE_2__.connect)(mapStateToProps, mapDispatchToProps)(Frontend)));
