(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_User_Plans_index_js"],{
...
/***/ "./resources/js/src/containers/Backend/User/Plans/index.js":
/*!*****************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Plans/index.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var data = plans.map(function (plan) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_12__.updateObject)(plan, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_12__.convertDate)(plan.created_at),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_11__.getPlans(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_11__.deletePlans(id));
    },
    reset: function reset() {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_11__.resetPlans());
    }
  };
};
